 ...
 */
module.exports.generateToken = function(key) {
    var hmac = crypto.createHmac('sha256', secret);
    hmac.update(key+new Date().getTime());
...
function getMessage(code){
    switch (code){
        ...
        case Code.CONNECTION.OFF_LINE : return "对方未在线";
        case Code.DEVICE.NOT_EXIST : return "设备不存在";
        case Code.AUTHORITY.NO_AUTHORITY : return "没有权限"
        case Code.MERCHANT.NOT_EXIST : return "商家不存在"
        default : return "未知错误";
    }
}